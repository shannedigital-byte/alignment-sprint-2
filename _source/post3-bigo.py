#!/usr/bin/env python3
"""Post 3 — The Big O. Question-led static, in-hand product card. 1080x1350, Hello Nancy brand kit."""
import os
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  body{font-family:'DM Sans',sans-serif;color:var(--ink);background:var(--cream);overflow:hidden;position:relative}
  ...
  .bar .num{font-family:'Fraunces',serif;font-weight:900;font-size:40px}
  ...
  .tag{font-family:'Fraunces',serif;font-weight:600;font-style:italic;font-size:30px;color:var(--ink);opacity:.55}
  .spark{position:absolute}
</style></head><body>
<div class="frame">

  <svg class="spark" style="left:44px;top:210px" width="76" height="76" viewBox="0 0 76 76">
    <g stroke="#282826" stroke-width="5" stroke-linecap="round">
  ...
  <div class="mid">
    <div class="stage">
      ...
      <div class="bar">
        <span class="lab">Alone <span class="num" style="color:var(--pink)">95%</span></span>
        <span class="sep"></span>
        <span class="lab" style="color:var(--dawn)">Together <span class="num">69%</span></span>
      </div>
    </div>
  </div>
  ...
  <div class="foot">
    ...
    <span class="tag">Let&rsquo;s talk about this</span>
  </div>
</div>
</body></html>'''

open(os.path.join(BASE, "post3-bigo.html"), "w").write(HTML)
print("wrote post3-bigo.html")
